...
void keyReleased(){
  if((dist(Posx1,Posy1,mouseX,mouseY)<50) && (keyPressed)){ 
    if (key=='a'){
  ...
  if((dist(Posx2,Posy2,mouseX,mouseY)<50) && (keyPressed)){ 
    if (key=='a'){
  ...
  if((dist(Posx3,Posy3,mouseX,mouseY)<50) && (keyPressed)){ 
    if (key=='a'){
  ...
  if((dist(Posx4,Posy4,mouseX,mouseY)<50) && (keyPressed)){ 
    if (key=='a'){
  ...
  if((dist(Posx5,Posy5,mouseX,mouseY)<50) && (keyPressed)){ 
    if (key=='a'){
  ...
  if((dist(Posx6,Posy6,mouseX,mouseY)<50) && (keyPressed)){ 
    if (key=='a'){
  ...
  if((dist(Posx7,Posy7,mouseX,mouseY)<50) && (keyPressed)){ 
    if (key=='a'){
